...
`flet build` command supersedes both [`flet pack`](https://docs.flet-docs.pages.dev/cookbook/packaging-desktop-app) (packaging into desktop app) and [`flet publish`](https://docs.flet-docs.pages.dev/publish/web/static-website) (packaging into a static website) commands and allows converting your Flet app into Android or iOS bundle, desktop app and a static website.
...
Check [Packaging app for distribution](https://docs.flet-docs.pages.dev/publish) guide for complete information about `flet build` command.
