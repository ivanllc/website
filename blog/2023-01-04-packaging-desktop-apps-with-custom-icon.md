...
`flet` command has been used for running Flet program with [hot reload](https://docs.flet-docs.pages.dev/reference/cli/run), but we recently re-worked Flet CLI to support multiple actions.
...
Find all available options for packaging desktop apps in the [updated guide](https://docs.flet-docs.pages.dev/publish).
