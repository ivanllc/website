...
It is recommended to add file picker to [`page.overlay.controls`](https://docs.flet-docs.pages.dev/controls/page#overlay) collection, so it doesn't affect the layout of your app. Despite file picker has 0x0 size it is still considered as a control when put into `Row` or `Column`.
...
Check [File picker](https://docs.flet-docs.pages.dev/controls/filepicker) control docs for all available dialog methods and their parameters.
...
See [File picker](https://docs.flet-docs.pages.dev/controls/filepicker) control docs for all its properties and examples.
