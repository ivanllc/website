...
Unleash your inner artist 🧑‍🎨 and boost your Flet creativity with brand-new [Canvas](https://docs.flet-docs.pages.dev/controls/canvas) control just released in [Flet 0.6.0](https://pypi.org/project/flet/)!
...
Combine Canvas with [GestureDetector](https://docs.flet-docs.pages.dev/controls/gesturedetector) and you get a free-hand drawing app - Flet Brush 😀!
...
Here's a simple program drawing a smiley face with [`Circle`](https://docs.flet-docs.pages.dev/controls/canvas#circle-shape-properties) and [`Arc`](https://docs.flet-docs.pages.dev/controls/canvas#arc-shape-properties) shapes using filled and stroke [`Paint`](https://docs.flet-docs.pages.dev/reference/types/paint):
...
Read more about Canvas in [docs](https://docs.flet-docs.pages.dev/controls/canvas) and explore [Canvas examples](https://github.com/flet-dev/examples/tree/main/python/controls/canvas)!

## Other changes

### Rich text support

While working on [drawing text on Canvas](https://docs.flet-docs.pages.dev/controls/canvas#drawing-text), as a bonus to this release, we implemented a new [`TextSpan`](https://docs.flet-docs.pages.dev/reference/types/textspan) control which can now be used with [`Text.spans`](https://docs.flet-docs.pages.dev/controls/text#spans) to output rich text.

<img src="/img/docs/controls/text/richtext-borders-stroke.png" className="screenshot-60" />

Check rich text examples: [one](https://docs.flet-docs.pages.dev/controls/text#rich-text-basics), [two](https://docs.flet-docs.pages.dev/controls/text#rich-text-with-borders-and-stroke) and [three](https://docs.flet-docs.pages.dev/controls/text#rich-text-with-gradient).

### `url` property for buttons

If you need to open a URL by clicking on a button or any other control with `on_click` event you can just provide that URL in `url` instead of doing that in the code with [`page.launch_url()`](https://docs.flet-docs.pages.dev/controls/page#launch_urlurl) method.
