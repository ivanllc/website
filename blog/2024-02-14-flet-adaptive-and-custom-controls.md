...
3) New controls: [`Video`](https://docs.flet-docs.pages.dev/controls/video) (yay!), [`AudioRecorder`](https://docs.flet-docs.pages.dev/controls/audiorecorder) and a bunch of `Cupertino`-like controls. Flet now includes 97 built-in controls!

<!-- truncate -->

:::warning
Flet 0.20.0 includes a new [`Video`](https://docs.flet-docs.pages.dev/controls/video) control. While macOS and Windows already include all required media libraries to test Flet apps on Linux, the [libmpv](https://mpv.io/) package must be installed. On Ubuntu/Debian in can be installed with:
