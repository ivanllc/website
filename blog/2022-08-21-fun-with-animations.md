...
* [Opacity](https://docs.flet-docs.pages.dev/cookbook/animations#opacity-animation)
* [Rotation](https://docs.flet-docs.pages.dev/cookbook/animations#rotation-animation) (new in this release)
* [Scale](https://docs.flet-docs.pages.dev/cookbook/animations#scale-animation) (new in this release)
* [Offset](https://docs.flet-docs.pages.dev/cookbook/animations#offset-animation) (new in this release)
* [Position](https://docs.flet-docs.pages.dev/cookbook/animations#position-animation)

Additionally, all `Container` control properties [can be now animated](https://docs.flet-docs.pages.dev/cookbook/animations#animated-container) and there is a new [`AnimatedSwitcher`](https://docs.flet-docs.pages.dev/controls/animatedswitcher) control for animated transition between old a new content.
...
[See `Markdown` control docs](https://docs.flet-docs.pages.dev/controls/markdown) for more information and examples.
...
`Page` now contains [`on_keyboard_event`](https://docs.flet-docs.pages.dev/controls/page#on_keyboard_event) event handlet to globally intercept all keystrokes.
...
We added [Accessibility](https://docs.flet-docs.pages.dev/cookbook/accessibility) section to the docs covering semantics support for screen readers.

### `ShaderMark` control

A control that applies a mask generated by a shader to its content. Allows making nice effects like [gradually fading out images](https://docs.flet-docs.pages.dev/controls/shadermask#gradually-fade-out-image-to-the-bottom-edge).
